...
foreach outcome of local outcomes{
  reghdfe `outcome' i.recip_race_g io(10 20 30 40 50).plan_race_asgn i.plan_id_asgn, ///
...
// Demo + HCCs
foreach outcome of local outcomes{
  reghdfe `outcome' i.recip_race_g io(10 20 30 40 50).plan_race_asgn i.plan_id_asgn hcc_*,  ///
       absorb(uor recip_age_g recip_gender_g recip_zip elig_cat) cluster(uor)
