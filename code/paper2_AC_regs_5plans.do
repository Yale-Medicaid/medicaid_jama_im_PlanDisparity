...
foreach outcome of local outcomes{
  reghdfe `outcome' io(10 20 30 40 50).plan_race i.plan_id, ///
  ...
  test 11.plan_race = 21.plan_race = 31.plan_race = 41.plan_race = 51.plan_race
...
// Demo + HCCs
foreach outcome of local outcomes{
  reghdfe `outcome' io(10 20 30 40 50).plan_race i.plan_id hcc_*,  ///
       absorb(uor recip_age_g recip_gender_g recip_zip elig_cat) cluster(uor)
